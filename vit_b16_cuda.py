...
torch.save(model.state_dict(), "./vitb16/vitb16_cuda_224.pth")

X = np.arange(0,len(model_results["train_loss"]),1)

plt.rcParams['text.usetex'] = True

figure, axis = plt.subplots(2, 2, figsize=(12, 12)) 
axis[0,0].plot(X,model_results["train_loss"])
axis[0,0].set_title("Training loss")

axis[0,1].plot(X,model_results["train_acc"])
axis[0,1].set_title("Training accuracy")

axis[1,0].plot(X,model_results["test_loss"])
axis[1,0].set_title("Test loss")

axis[1,1].plot(X,model_results["test_acc"])
axis[1,1].set_title("Test accuracy")

figure.savefig("vitb16_classifier_metrics.jpg")